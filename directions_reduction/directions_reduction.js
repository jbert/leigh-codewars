...
direction and coming back the opposite direction is a needless effort. Since this is the wild west,
with dreadfull weather and not much water, it's important to save yourself some energy, otherwise
...
You can immediatly see that going "NORTH" and then "SOUTH" is not reasonable, better stay to the
same place! So the task is to give to the man a simplified version of the plan. A better plan in
this case is simply:
...
back right away. What a waste of time! Better to do nothing.
...
console.assert(dirReduc(['NORTH']), ['NsORTH']);
...
Expected: '[\'WEST\']', instead got: 'undefined'
Expected: '[\'NORTH\', \'WEST\', \'SOUTH\', \'EAST\']', instead got: 'undefined'
